...
const Header = () => {
  ...
  // Adicionamos uma propriedade 'dropdown' para saber onde colocar a seta
  const navLinks = [
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="relative text-center lg:text-left">
                        ...
                        <div className="relative flex flex-col sm:flex-row items-center justify-center lg:justify-start mt-[-1.5rem] md:mt-[-2.5rem] lg:ml-4">
                             {/* Cor ajustada para um verde-limão mais vibrante */}
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Sombra ajustada para 'shadow-lg' (mais subtil) e adicionada uma borda leve */}
...
const Services = () => {
    const serviceItems = [
        { title: 'Web Design And Development', icon: '📦', description: "Established In 1995, NEXIN Has Been Leading Force In The Digital Landscape For Over Two Decades. We're A Passionate" },
        { title: 'Branding And Creative Services', icon: '⌘', description: "Established In 1995, NEXIN Has Been Leading Force In The Digital Landscape For Over Two Decades. We're A Passionate" },
        { title: 'Creative Digital Agency', icon: '⬢', description: "Established In 1995, NEXIN Has Been Leading Force In The Digital Landscape For Over Two Decades. We're A Passionate" },
    ];
    return (
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {serviceItems.map((item) => (
                        <div key={item.title} className="border border-gray-200 rounded-lg p-8 text-center hover:shadow-2xl hover:border-green-400 transition-all duration-300 transform hover:-translate-y-2">
...
const Workflow = () => {
    const steps = [
        { number: '01', title: 'Research and Strategy', icon: '🚀', description: 'Conduct thorough market of the research to the fast target audience behaviors. Submit as many design tasks.' },
        { number: '02', title: 'Plan Customization', icon: '🐼', description: 'Conduct thorough market of the research to the fast target audience behaviors. Submit as many design tasks.' },
        { number: '03', title: 'Finished & User Testing', icon: '🔄', description: 'Conduct thorough market of the research to the fast target audience behaviors. Submit as many design tasks.' },
    ];
    return (
